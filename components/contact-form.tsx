        ...
        <CardContent className="pt-6">
          <div className="text-center py-12 space-y-4 animate-in fade-in zoom-in duration-500">
            <div className="flex justify-center">
              <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center glow-primary">
    ...
    <Card className="bg-card/50 card-hover">
      ...
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <Button
            type="submit"
            className="w-full glow-primary glow-primary-hover transition-all"
            disabled={isSubmitting}
          >
            {isSubmitting ? (
              <>
